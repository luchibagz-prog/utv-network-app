  ...
  if (loading) {
    return (
      <main className="loading">
        ...
        <div className="loadingAmbient loadingAmbientMint" />
        <div className="loadingAmbient loadingAmbientPurple" />

        <section className="loadingStage">
          <div className="loadingLogoWrap">
            <div className="loadingLogoGlow" />
        ...
        <style jsx>{`
          ...
          .loadingLogo {
            ...
            box-shadow: none;
            filter:
              drop-shadow(0 0 18px rgba(82,247,200,.22))
              drop-shadow(0 0 38px rgba(123,97,255,.13));
          ...
          .loadingPulse span {
            ...
            border-radius: 999px;
            background: #52f7c8;
            box-shadow: 0 0 13px rgba(82,247,200,.38);
          ...
          .loadingAmbientMint {
            ...
            left: -180px;
            background: #52f7c8;
            animation: ambientMoveOne 7s ease-in-out infinite alternate;
          }

          .loadingAmbientPurple {
            right: -190px;
            bottom: 16%;
            background: #765cff;
            animation: ambientMoveTwo 8s ease-in-out infinite alternate;
          }
