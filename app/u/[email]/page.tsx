  ...
  if (loading) {
    return (
      ...
      >
        ...
        <section className="skeletonIdentity">
          <div className="skeletonAvatar" />

          <div className="skeletonIdentityCopy">
            <span className="skeletonLine nameLine" />
            <span className="skeletonLine handleLine" />
          </div>
        </section>

        <section className="skeletonActions">
          <span />
          <span />
          <span />
        </section>

        <section className="skeletonContent">
          <div className="skeletonCard">
            <span className="skeletonLine wideLine" />
            <span className="skeletonLine mediumLine" />
          </div>

          <div className="skeletonCard tallCard" />
        </section>
          ...
          .skeletonCard {
            ...
            background:
              linear-gradient(
                ...
                rgba(82,247,200,.12) 18%,
                rgba(123,97,255,.12) 26%,
...
.hero {
  ...
  /*
    Kill older oversized hero padding/min-height rules.
    Keep enough vertical space for the cover to feel premium.
  */
...
/* Disable older hero extension/fade */
.hero::after {
  display: none !important;
}

/*
  Keep the identity layout/location we already approved.
*/
.hero .identity {
  position: relative !important;
...
/* =========================================================
   UTV OG — ORIGINAL 100 STATUS CREDENTIAL
   Designed from the UTV World visual language
   ========================================================= */
...
.utvOgStatusPro {
  ...
  background:
    ...
    linear-gradient(
      ...
      rgba(82,247,200,.28) 58%,
      rgba(126,91,255,.34) 76%,
      rgba(255,201,73,.68)
    ) border-box;
...
.utvOgStatusPro::before {
  ...
  animation:
    utvOgPremiumSweep 5.2s ease-in-out infinite;
}
...
.utvOgStatusIcon {
  ...
  box-shadow:
    ...
    inset 0 -5px 9px rgba(0,0,0,.36),
    0 0 9px rgba(255,193,45,.08);
}
...
.utvOgStatusCopy small {
  margin: 0 0 3px;

  color: rgba(255,220,117,.76);
...
.utvOgStatusDot {
  ...
  box-shadow:
    0 0 8px rgba(255,208,73,.55);
}

@keyframes utvOgPremiumSweep {
  0%,
  68% {
    transform:
      translateX(0)
...
/* ===== END UTV PROFILE HEADER V3 FINAL ===== */
`}</style>
